...
## Trường hợp đặc biệt: missing_content do nội dung lệch trang

Nếu lỗi là missing_content và đoạn Markdown bên trên KHÔNG CHỨA nội dung của trang
trong hình ảnh (vì nó chứa nội dung của trang khác do lỗi mapping), hãy:
- Viết lại TOÀN BỘ đoạn Markdown dựa trên hình ảnh trang PDF gốc
- Chuyển đổi CHÍNH XÁC và ĐẦY ĐỦ nội dung nhìn thấy trên trang
- Giữ đúng định dạng Markdown (heading, list, table, bold)
- KHÔNG giữ nội dung cũ nếu nó thuộc trang khác
